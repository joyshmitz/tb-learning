...
First, you should create the Uplink Data Converter according to the device protocol. The converter will decode incoming telemetry payload data from wM-Bus Reader LoRaWAN “Smartico WM-LR” that contains in encoded Base64 string to human readable, simplified ThingsBoard data format. Import [uplink_wmbus_reader.json](/thingsboard-learning/docs/samples/smartico/wm-bus-lorawan/resources/uplink_wmbus_reader.json) file with Uplink data converter.
...
To display data to users, you need to create a dashboard that can be imported from [dashboard_wmbus_reader.json](/thingsboard-learning/docs/samples/smartico/wm-bus-lorawan/resources/dashboard_wmbus_reader.json)  file. 

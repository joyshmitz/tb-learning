...
Main characteristics of the subscription plan are: [entity limits](/thingsboard-learning/docs/{{docsPrefix}}user-guide/tenant-profiles/#entity-limits), [api limits](/thingsboard-learning/docs/{{docsPrefix}}user-guide/tenant-profiles/#api-limits--usage), [white-labeling](#white-labeling) and the level of support you get.   
...
See feature [documentation](/thingsboard-learning/docs/{{docsPrefix}}user-guide/white-labeling/) for more details. ThingsBoard Cloud extends white-labeling feature with ability to configure own domain name easily. 
See [managing domain](/thingsboard-learning/docs/{{docsPrefix}}domains/) for more details. 
